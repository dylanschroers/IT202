...
<tr><td> <em>Generated: </em> 2/14/2022 12:45:14 AM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-004-S22/m2-php-hw/grade/djs28" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/60888108/153806120-c859c6ea-ca7e-49db-878a-9537bf57615c.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Shows the odd numbers of the array in the proper part of the<br>screen.<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I created a foreach loop that used modulo to test if the number<br>from the array was odd, and if it was to echo it.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/60888108/153806552-21b5943c-0863-4933-87b4-9fb66e51f9aa.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the total from the array in the proper part of the screen.<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I created a foreach loop that used += to increase total from all<br>the values of the array and then echo it.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/60888108/153806580-6642e16e-9e9a-49ad-b8da-0c322e231624.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the numbers from the array as positive numbers regardless of what they<br>were before in the proper part of the screen.<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I created a foreach loop that used used the abs function in php<br>to change number from the array to positive regardless of what it was<br>before echo it.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://djs28-prod.herokuapp.com/M2/problem1.php">https://djs28-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://djs28-prod.herokuapp.com/M2/problem2.php">https://djs28-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://djs28-prod.herokuapp.com/M2/problem3.php">https://djs28-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/dylanschroers/IT202/pull/8">https://github.com/dylanschroers/IT202/pull/8</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>I had an issue that Heroku wouldn&#39;t deploy the newest version, and it<br>was because I created the M2 folder outside of the public_html folder, so<br>i guess I learned the importance of putting stuff inside of the public_html<br>folder.<br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-004-S22/m2-php-hw/grade/djs28" target="_blank">Grading</a></td></tr></table>